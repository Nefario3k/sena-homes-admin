<template>
  <div>
      ...
      <v-row class="content_row" style="margin-top: 0">
        ...
        <div class="col-12 header_wrapper">
          ...
          <div class="listing_header_btns">
            <v-btn to="/admin/manage/create?query=Admins" class="Btn">
              <div class="Btn_wrapper">
                ...
                >
                  <path d="M8 4L8 12" stroke="white" stroke-linecap="round" />
                  <path d="M12 8L4 8" stroke="white" stroke-linecap="round" />
                </svg>
          ...
          <v-card class="table_card_container">
            ...
            >
              ...
              <template v-slot:item.role="{ item }">
                <div class="user_content">
                  <p class="table_number_stats">{{ item.role }}</p>
                </div>
              </template>
              ...
              <template v-slot:item.date="{ item }">
                <div class="user_content">
                  <p class="table_number_stats">{{ item.date }}</p>
                </div>
              </template>
              ...
              <template v-slot:item.activity="{ item }">
                <div class="user_content">
                  <p class="table_number_stats">{{ item.activity }}</p>
                </div>
              </template>
              ...
              <template v-slot:item.action="{ item }">
                <v-menu min-width="147" bottom offset-y :nudge-bottom="5">
                  ...
                  <v-list elevation="0" flat nav dense class="dropdownList">
                    ...
                    <!-- edit admin  -->
                    <nuxt-link to="/admin/manage/edit?query=Admins">
                      <v-list-item class="ItemList" style="padding-left: 12px">
                        <v-list-item-icon
            ...
            <v-expansion-panels
              ...
              class="mobileTable"
            >
              <v-expansion-panel v-for="(item, index) in userData" :key="index">
            ...
            <div class="viewMoreUsers">
              <div class="show_results">
                <span>Showing 1 to 5 of 7 results</span>
              </div>
    ...
    <ModalDeleteAdmin ref="deleteAdmin" />
  </div>
</template>
...
export default {
  ...
  methods: {
    showModal(type) {
      switch (type) {
        case "deleteAdmin":
          this.$refs.deleteAdmin.showDialogue();
          break;
        case "viewUser":
