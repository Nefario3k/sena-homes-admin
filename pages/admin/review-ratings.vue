                ...
                <v-list elevation="0" flat nav dense class="dropdownList">
                  ...
                  <v-list-item class="ItemList" style="padding-left: 12px">
                    <v-list-item-icon style="margin: 10px 5px 0 0 !important">
                      ...
                      >
                        ...
                        <path d="M6 9.5L8.25 11.75L12 7.25" stroke="#1C212B" />
                      </svg>
                    </v-list-item-icon>
                  ...
                  <v-list-item class="ItemList" style="padding-left: 12px">
                    <v-list-item-icon style="margin: 10px 5px 0 0 !important">
                      ...
                      >
                        <circle cx="9" cy="9.5" r="6.75" stroke="#1C212B" />
                        <path d="M5.625 9.5H12.375" stroke="#1C212B" />
                      </svg>
                    </v-list-item-icon>
        ...
        <div class="col-12 users_table">
          <v-card class="table_card_container">
            ...
            <v-data-table
              ...
              class="generic_data_table reviews_table"
            >
              <!-- property details  -->
                  ...
                  <div class="user_content_details">
                    <div class="user_details">
                      ...
                      <v-chip
                        ...
                        :ripple="false"
                        small
                        text-color="var(--chip-disabled-color)"
                        color="var(--chip-disabled-bg-color)"
                        class="chipped"
                      >
                        Pending
                      </v-chip>
              ...
              <template v-slot:item.ratings="{ item }">
                <div class="user_content">
                  <div class="ratings_p">
                    ...
                    >
                      <path
                        d="M10.1439 6.629C10.9305 4.668 11.3238 3.6875 12.0001 3.6875C12.6764 3.6875 13.0697 4.668 13.8563 6.629L13.893 6.72031C14.3373 7.82818 14.5595 8.38212 15.0124 8.7188C15.4652 9.05549 16.0597 9.10873 17.2486 9.21521L17.4636 9.23446C19.4094 9.40872 20.3823 9.49585 20.5905 10.1148C20.7986 10.7338 20.0761 11.3912 18.6311 12.7058L18.1488 13.1446C17.4173 13.8101 17.0515 14.1429 16.8811 14.579C16.8493 14.6604 16.8228 14.7437 16.8019 14.8285C16.6899 15.2832 16.797 15.7659 17.0112 16.7314L17.0778 17.0319C17.4715 18.8063 17.6684 19.6934 17.3247 20.0761C17.1963 20.2191 17.0293 20.322 16.8439 20.3726C16.3477 20.508 15.6433 19.934 14.2343 18.7859C13.3091 18.032 12.8465 17.6551 12.3154 17.5703C12.1065 17.5369 11.8937 17.5369 11.6847 17.5703C11.1536 17.6551 10.6911 18.032 9.76589 18.7859C8.35694 19.934 7.65246 20.508 7.15626 20.3726C6.97084 20.322 6.80393 20.2191 6.67551 20.0761C6.33183 19.6934 6.52866 18.8063 6.92234 17.0319L6.98902 16.7314C7.20322 15.7659 7.31033 15.2832 7.19827 14.8285C7.17737 14.7437 7.15093 14.6604 7.11913 14.579C6.94866 14.1429 6.58291 13.8101 5.8514 13.1446L5.36912 12.7059C3.92408 11.3912 3.20155 10.7338 3.40973 10.1148C3.61791 9.49585 4.59082 9.40872 6.53663 9.23446L6.75157 9.21521C7.94049 9.10873 8.53494 9.05549 8.98779 8.7188C9.44064 8.38212 9.66284 7.82818 10.1072 6.72031L10.1439 6.629Z"
                        fill="#FFD841"
                        stroke="#FFD841"
                      />
                    </svg>
...
export default {
  data() {
    return {
      ...
      listItem: [
        { title: "All", value: 322 },
        { title: "Pending", value: 289 },
        { title: "Approved", value: 17 },
        { title: "Disapproved", value: 16 },
      ],
      currentView: "All",
