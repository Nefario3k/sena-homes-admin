    ...
    <section id="pageBody">
      <v-row class="content_row" style="margin-top: 0">
        ...
        <div class="col-12 header_wrapper">
          <header>Edit Home Page Content</header>
        </div>
                ...
                <v-tabs-items v-model="tab">
                  ...
                  <v-tab-item>
                    <v-row>
                      ...
                      <!-- subtext  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="subtext_hero">Subtext</label>
                        <div class="relative">
                          <textarea
                            id="subtext_hero"
                            v-model="hero.subtext"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                  ...
                  <v-tab-item>
                    <v-row>
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="header01">Header</label>
                        <div class="relative">
                          <textarea
                            id="header01"
                            v-model="property.header[0]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- subtitle  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="subtitle01">Subtitle</label>
                        <div class="relative">
                          <textarea
                            id="subtitle01"
                            v-model="property.subtitle[0]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="header02">Header</label>
                        <div class="relative">
                          <textarea
                            id="header02"
                            v-model="property.header[1]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- subtitle  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="subtitle02">Subtitle</label>
                        <div class="relative">
                          <textarea
                            id="subtitle02"
                            v-model="property.subtitle[1]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="header03">Header</label>
                        <div class="relative">
                          <textarea
                            id="header03"
                            v-model="property.header[2]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- subtitle  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="subtitle03">Subtitle</label>
                        <div class="relative">
                          <textarea
                            id="subtitle03"
                            v-model="property.subtitle[2]"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                  ...
                  <v-tab-item>
                    <v-row>
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label>Section displayed on multiple pages</label>
                        <div class="relative">
                          <textarea
                            disabled
                            style="
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="cta_header">Header</label>
                        <div class="relative">
                          <textarea
                            id="cta_header"
                            v-model="cta.header"
                      ...
                      <!-- subtext  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="cta_subtext">Subtext</label>
                        <div class="relative">
                          <textarea
                            id="cta_subtext"
                            v-model="cta.subtext"
                  ...
                  <v-tab-item>
                    <v-row>
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="mobile_header">Header</label>
                        <div class="relative">
                          <textarea
                            id="mobile_header"
                            v-model="mobile.header"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- subtext  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="mobile_subtext">Subtext</label>
                        <div class="relative">
                          <textarea
                            id="mobile_subtext"
                            v-model="mobile.subtext"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
...
export default {
  data() {
    return {
      tab_open: false,
      hero: {
        header: "Easy way to find a perfect property",
        subtext:
          "A great platform to rent, lease, or even buy  properties without any commissions.",
      },
      cta: {
        header: "Find your best Real Estate",
        subtext:
          "We provide a complete service for the sale, Purchase or rental of real estate.",
      },
      mobile: {
        header: "Get our mobile app now",
        subtext:
          "A great platform to rent, lease, or even buy  properties without any commissions.",
      },
      about: {
        header: "Find Comfortable Real Estate Here",
        card1: {
          header: "High Quality Homes",
          subtext: "SENA HOMES is all about luxury, style and comfort.",
        },
        card2: {
          header: "High Quality Homes",
          subtext: "SENA HOMES is all about luxury, style and comfort.",
      ...
      infoText:
        "Changes made in this section will affect other pages. Please review before saving.",
      tab: 0,
      tabItem: ["Hero Section", "Properties", "About Us", "CTA", "Mobile App"],
    };
  },
  mounted() {},
  methods: {
