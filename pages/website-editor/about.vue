    ...
    <section id="pageBody">
      <v-row class="content_row" style="margin-top: 0">
        ...
        <div class="col-12 header_wrapper">
          <header>Edit About Page Content</header>
        </div>
                ...
                <v-tabs-items v-model="tab">
                  ...
                  <v-tab-item>
                    <v-row>
                      ...
                      <!-- subtext  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="header">Subtext</label>
                        <div class="relative">
                          <textarea
                            id="header"
                            v-model="header.subtext"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                  ...
                  <v-tab-item>
                    <v-row>
                      <!-- title  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="header01">Title</label>
                        <div class="relative">
                          <textarea
                            id="header01"
                            v-model="who.title"
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="subtitle01">Header</label>
                        <div class="relative">
                          <textarea
                            id="subtitle01"
                            v-model="who.header"
                      ...
                      <!-- rich text editor  -->
                      <div class="col-12 inputArea amenities_section">
                        <label><span>Body Text</span> </label>
                        <div class="amenities_section_wrapper text_editor">
                          <client-only>
                            <VueEditor
                              id="editor"
                              :editorToolbar="customToolbar"
                              v-model="who.longText"
                              placeholder="Description"
                            />
                          </client-only>
                        </div>
                  ...
                  <v-tab-item>
                    <v-row>
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="why_choose_header">Header</label>
                        <div class="relative">
                          <textarea
                            id="why_choose_header"
                            v-model="why_choose.header"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                  ...
                  <v-tab-item>
                    <v-row>
                      <!-- title  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="believe_title">Title</label>
                        <div class="relative">
                          <textarea
                            id="believe_title"
                            v-model="believe.title"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="believe_header">Header</label>
                        <div class="relative">
                          <textarea
                            id="believe_header"
                            v-model="believe.header"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <div class="col-12 inputArea amenities_section">
                        ...
                        <div class="amenities_section_wrapper">
                          <div class="imagesRow">
                            <v-row class="text_container">
                              <div
                                v-for="(text, index) in believe.believeTexts"
                                :key="index"
                                class="
                    ...
                    <v-row>
                      ...
                      <div class="col-12 inputArea">
                        <div class="user_content">
                          <v-switch
                            label="Enable or Disable Section"
                            style="margin-left: 3px"
                            color="var(--primary-color)"
                            v-model="team.active"
                            inset
                          ></v-switch>
                          <p class="team_active_details">
                            Section 6 (Teams) Disabled
                          </p>
                        </div>
                      </div>
                      ...
                      <!-- header  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="team_header">Header</label>
                        <div class="relative">
                          <textarea
                            id="team_header"
                            v-model="team.header"
                      ...
                      <!-- subtext  -->
                      <div class="col-12 col-md-6 col-lg-6 col-xl-6 inputArea">
                        <label for="team_subtext">Subtext</label>
                        <div class="relative">
                          <textarea
                            id="team_subtext"
                            v-model="team.subtext"
                            placeholder="Description"
                            rows="3"
                            maxlength="2000"
                            cols=""
                      ...
                      <div class="col-12 inputArea amenities_section">
                        ...
                        <div class="amenities_section_wrapper">
                          <div class="imagesRow">
                            <v-row class="team_container">
                              <div
                                v-for="(member, index) in team.teams"
                                :key="index"
                                class="col-12 col-md-4 col-lg-4 col-xl-3"
                              >
                                <div class="border_team">
                                  <label><span>Header</span> </label>
                                  <div class="team_select_section">
                                    <div class="relative img_logo">
                                      <svg
                                        width="119"
                                        height="119"
                                        viewBox="0 0 119 119"
                                      ...
                                      >
                                        ...
                                        <g clip-path="url(#clip0_0_1)">
                                          <path
                                            d="M64.1152 46.0547H50.8103C49.5506 46.0562 48.3428 46.5573 47.452 47.4481C46.5612 48.3389 46.0601 49.5466 46.0586 50.8064V64.1113C46.0601 65.3711 46.5612 66.5788 47.452 67.4696C48.3428 68.3604 49.5506 68.8615 50.8103 68.863H64.1152C65.375 68.8615 66.5827 68.3604 67.4735 67.4696C68.3643 66.5788 68.8654 65.3711 68.8669 64.1113V50.8064C68.8654 49.5466 68.3643 48.3389 67.4735 47.4481C66.5827 46.5573 65.375 46.0562 64.1152 46.0547V46.0547ZM50.8103 47.9554H64.1152C64.8713 47.9554 65.5965 48.2558 66.1312 48.7904C66.6659 49.3251 66.9662 50.0503 66.9662 50.8064V64.1113C66.9646 64.5347 66.8671 64.9522 66.6811 65.3325L57.9731 56.6244C57.5318 56.1831 57.008 55.833 56.4314 55.5941C55.8548 55.3552 55.2368 55.2323 54.6127 55.2323C53.9886 55.2323 53.3706 55.3552 52.794 55.5941C52.2174 55.833 51.6935 56.1831 51.2522 56.6244L47.9593 59.9165V50.8064C47.9593 50.0503 48.2597 49.3251 48.7943 48.7904C49.329 48.2558 50.0542 47.9554 50.8103 47.9554ZM50.8103 66.9623C50.0542 66.9623 49.329 66.662 48.7943 66.1273C48.2597 65.5926 47.9593 64.8674 47.9593 64.1113V62.604L52.5951 57.9682C52.8598 57.7033 53.1742 57.4931 53.5203 57.3497C53.8663 57.2063 54.2372 57.1325 54.6117 57.1325C54.9863 57.1325 55.3572 57.2063 55.7032 57.3497C56.0492 57.4931 56.3636 57.7033 56.6284 57.9682L65.3364 66.6772C64.9561 66.8632 64.5386 66.9607 64.1152 66.9623H50.8103Z"
                                            fill="#A1A7AD"
                                          />
                                          <path
                                            d="M61.2637 56.0274C61.9216 56.0274 62.5647 55.8324 63.1117 55.4669C63.6587 55.1014 64.085 54.5819 64.3367 53.9741C64.5885 53.3663 64.6544 52.6975 64.526 52.0523C64.3977 51.4071 64.0809 50.8144 63.6157 50.3492C63.1505 49.884 62.5579 49.5673 61.9126 49.4389C61.2674 49.3106 60.5986 49.3764 59.9908 49.6282C59.383 49.8799 58.8636 50.3063 58.4981 50.8533C58.1326 51.4003 57.9375 52.0434 57.9375 52.7012C57.9375 53.5834 58.2879 54.4294 58.9117 55.0532C59.5355 55.677 60.3815 56.0274 61.2637 56.0274ZM61.2637 51.2757C61.5457 51.2757 61.8213 51.3593 62.0557 51.5159C62.2901 51.6726 62.4728 51.8952 62.5807 52.1557C62.6886 52.4162 62.7169 52.7028 62.6618 52.9793C62.6068 53.2558 62.4711 53.5098 62.2717 53.7092C62.0723 53.9086 61.8183 54.0443 61.5418 54.0993C61.2653 54.1544 60.9787 54.1261 60.7182 54.0182C60.4577 53.9103 60.2351 53.7276 60.0784 53.4932C59.9218 53.2588 59.8382 52.9832 59.8382 52.7012C59.8382 52.3231 59.9884 51.9606 60.2557 51.6932C60.5231 51.4259 60.8856 51.2757 61.2637 51.2757Z"
                                            fill="#A1A7AD"
                                          />
                                          <path
                                            d="M64.9532 59.6619L64.9532 59.6619C64.354 60.2611 64.0173 61.0739 64.0173 61.9214V63.6843H62.2544C61.4069 63.6843 60.5941 64.021 59.9949 64.6202L59.9949 64.6202C59.3956 65.2195 59.059 66.0322 59.059 66.8797C59.059 67.7272 59.3956 68.5399 59.9949 69.1392C60.5941 69.7384 61.4069 70.0751 62.2544 70.0751H64.0173V71.838C64.0173 72.6855 64.354 73.4982 64.9532 74.0975C65.5525 74.6967 66.3652 75.0334 67.2127 75.0334C68.0602 75.0334 68.8729 74.6967 69.4722 74.0975C70.0714 73.4982 70.4081 72.6855 70.4081 71.838V70.0751H72.171C73.0185 70.0751 73.8312 69.7384 74.4305 69.1392C75.0297 68.5399 75.3664 67.7271 75.3664 66.8797C75.3664 66.0322 75.0297 65.2195 74.4305 64.6202C73.8312 64.021 73.0185 63.6843 72.171 63.6843H70.4081V61.9214C70.4081 61.0739 70.0714 60.2611 69.4722 59.6619C68.8729 59.0626 68.0602 58.726 67.2127 58.726C66.3652 58.726 65.5525 59.0626 64.9532 59.6619Z"
                                            fill="#A1A7AD"
                                            stroke="white"
                                            stroke-width="4.40741"
                                          />
                                      ...
                                      <div class="absolute delete_svg">
                                        ...
                                        >
                                          <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M13.6294 26.8507C20.9319 26.8507 26.8517 20.9309 26.8517 13.6285C26.8517 6.32604 20.9319 0.40625 13.6294 0.40625C6.32702 0.40625 0.407227 6.32604 0.407227 13.6285C0.407227 20.9309 6.32702 26.8507 13.6294 26.8507ZM6.28449 15.0976H20.9758V12.1593H6.28449V15.0976Z"
                                            fill="#EE0D0D"
                                          />
                                        </svg>
                                      </div>
...
export default {
  data() {
    return {
      ...
      header: {
        header: "About Sena Homes",
        subtext:
          "There are many variations of passages of Lorem Ipsum available but the this in majority have suffered alteration in some",
      },
      who: {
        title: "About Sena Homes",
        header:
          "There are many variations of passages of Lorem Ipsum available but the this in majority have suffered alteration in some",
        longText: `SENA Homes Real Estate is a property consultancy firm based in Dubai tailored to serve the challenging demands in the realty industry. We deal in residential and commercial properties and aim to provide the best properties that work within the client’s criteria. Our team members are expert realtors who go the extra mile to provide best property options to the clients.
        SENA Homes Real Estate is a RERA-licensed Organization established by professionalism, integrity, accountability, and quality service giving you the most profitable Quick Sale/rental Solutions today. We have a vision of providing our clients with an unparalleled experience.`,
      },
      mission: {
        mission:
          "To offer quality driven, excellent and, superior customer experience by combining entrepreneurial aptitude, innovative strategies and bespoke service to guarantee client satisfaction that results in long lasting partnership. We pride ourselves on flawless integrity and loyalty to our clients.",
        vision:
          "To be the topmost leading service provider in the real estate industry and to make Sena Homes the first choice of every property seeker. We are committed to meeting the needs of our clients.",
      },
      why_choose: {
        title: "WHY CHOOSE US.",
        header: "Why Sena Homes Real Estate?",
        longText: `With a desire for superiority in all our ventures, SENA HOMES is devoted to creating value by bringing you sophisticated, modern and, beautiful homes/properties with cautiously mapped-out and functional designs to suit your lifestyle. With proactive industry leading brokers and agents, the SENA HOMES team provides high-quality service delivery and maximum value for money in a competitive property market. Our expertise combined with professionalism and strategic alliances facilitates a world-class service delivery that permits us to promptly exceed our clients’ expectations`,
      },
      believe: {
      ...
      team: {
        ...
        header: "The Team",
        subtext:
          "The SENA HOMES REAL ESTATE management team consists of highly respected individuals with years of professional experience and a solid industry reputation.",
        teams: [
          { name: "Grant Marshall", role: "Agents" },
          { name: "Grant Marshall", role: "Agents" },
          { name: "Grant Marshall", role: "Agents" },
        ],
      },
